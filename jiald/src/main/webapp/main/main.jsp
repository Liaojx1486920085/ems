...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".aa").css({
                "background-image":"url(${pageContext.request.contextPath}/picture/6c42c40ed54f4bb5ea491894aff693878afa6580.png)","background-size":"100% 100%"
            })
            $("#ab").css({
                "background-image":"url(${pageContext.request.contextPath}/picture/08f98bb10251bb89461c0f3d50c864327b1ac05d.png)","background-size":"100% 100%"
            })
            <!--首页-->
            $("#ac").css({
                "background-image":"url(${pageContext.request.contextPath}/picture/2018-12-06_213544.png)","background-size":"100% 100%"
            })
...
<div data-options="region:'north',split:true" class="aa" style="height:100px; width: 100%">
    ...
    <div style="margin-left: 10px ; padding-top: 50px ; color: #FAF7F7;font-family: 楷体;float:right">欢迎您:${sessionScope.admin.name} &nbsp;<a href="#" onclick="updateAdmin()" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改密码</a>&nbsp;&nbsp;<a id="exit" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-01'">退出系统</a></div>
</div>
