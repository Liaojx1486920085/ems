			...
			<form id="loginForm" method="post" >
				...
				<table>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/CreateVcodeController/getVcode" title="点击更换验证码"/>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value=""><input onclick="log()" type="button" class="loginButton"  value="登录">
						</td>
					</tr>
				</tbody></table>
