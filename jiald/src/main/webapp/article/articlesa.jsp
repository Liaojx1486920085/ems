        ...
        $("#pl").edatagrid({
            ...
            columns:[[//定义列属性
                /*title:列标题头 ，
                  ...
                  */
                {title:'文章编号',field:'id',width:100,align:'center',resizable:true,fixed:true,checkbox:false,editor:{type:'validatebox',options:{required:true}}},
                {title:'文章标题',field:'title',width:80,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'插图路径',field:'articlePic',width:80,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'上传日期',field:'publicTime',width:140,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
