			...
			<div style="margin-top:10px">
				...
				<select class="easyui-combobox"  style="width: 300px;height: 40px " id="gurnId" name="gurnId">
					<c:forEach items="${sessionScope.gurus}" var="var">
						<center><option class='easyui-linkbutton' value='${var.id}'>${var.dharnaName}</option><br/></center>
					</c:forEach>
				</select>
			</div>
			<div style="margin-top:10px">
				上传封面: <input onchange="view_photo()" name="picPathUpdate" id="picPathUpdate" type="text"/><br/><span></span>
			</div>
