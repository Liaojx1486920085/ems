        ...
        $("#pg").edatagrid({
            ...
            columns:[[//定义列属性
                /*title:列标题头 ，
                  ...
                  */
                {title:'图片编号',field:'id',width:100,align:'center',resizable:true,fixed:true,checkbox:false,editor:{type:'validatebox',options:{required:true}}},
                {title:'图片名称',field:'picName',width:80,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'图片路径',field:'picPath',width:80,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'图片描述',field:'description',width:140,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'图片状态',field:'status',width:140,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
                {title:'上传时间',field:'createTime',width:140,align:'center',resizable:true,editor:{type:'validatebox',options:{required:true}}},
